...
function render() {
    if ($select.val() === "1") {
        ...
        $main.html(`
        <h3 class="weather-for">Weather for</h3>
        <p id="city">${cityData.city.name}</p>
        <h4>Temperature</h4>
        ...
        <p id="temp">Today ${cityData.list[4].main.temp}&#8457;</p>
        <p id="temp-2nd-day">Tomorrow ${cityData.list[12].main.temp}&#8457;</p>
        <p id-"temp-3rd-day">${day3} ${cityData.list[20].main.temp}&#8457;</p>
        <h4>Feels like</h4>
        <p id="feels-like">Today ${cityData.list[4].main.feels_like}&#8457;</p>
        <p id="feels-like-2nd-day">Tomorrow ${cityData.list[12].main.feels_like}&#8457;</p>
        <p id="feels-like-3rd-day">${day3} ${cityData.list[20].main.feels_like}&#8457;</p>
        <h4>Weather</h4>
        <p id="weather">Today ${cityData.list[4].weather[0].description}</p>
        <p id="weather-2nd-day">Tomorrow ${cityData.list[12].weather[0].description}</p>
        <p id="weather-3rd-day">${day3} ${cityData.list[20].weather[0].description}</p>
        `);
        ...
        <p id="temp-2nd-day">Tomorrow ${cityData.list[12].main.temp}&#8457;</p>
        <p id="temp-3rd-day">${day3} ${cityData.list[20].main.temp}&#8457;</p>
        <p id="temp-4th-day">${day4} ${cityData.list[28].main.temp}&#8457;</p>
        <h4>Feels like</h4>
        <p id="feels-like">Today ${cityData.list[4].main.feels_like}&#8457;</p>
        <p id="feels-like-2nd-day">Tomorrow ${cityData.list[12].main.feels_like}&#8457;</p>
        <p id="feels-like-3rd-day">${day3} ${cityData.list[20].main.feels_like}&#8457;</p>
        <p id="feels-like-4th-day">${day4} ${cityData.list[28].main.feels_like}&#8457;</p>
        <h4>Weather</h4>
        <p id="weather">Today ${cityData.list[4].weather[0].description}</p>
        <p id="weather-2nd-day">Tomorrow ${cityData.list[12].weather[0].description}</p>
        <p id="weather-3rd-day">${day3} ${cityData.list[20].weather[0].description}</p>
        <p id="weather-4th-day">${day4} ${cityData.list[28].weather[0].description}</p>
        `);
    } else {
        $main.html(`
        <h3 class="weather-for">Weather for:</h3>
        ...
        <p id="temp-3rd-day">${day3} ${cityData.list[20].main.temp}&#8457;</p>
        <p id="temp-4th-day">${day4} ${cityData.list[28].main.temp}&#8457;</p>
        <p id="temp-5th-day">${day5} ${cityData.list[36].main.temp}&#8457;</p>
        <h4>Feels like</h4>
        <p id="feels-like">Today ${cityData.list[4].main.feels_like}&#8457;</p>
        <p id="feels-like-2nd-day">Tomorrow ${cityData.list[12].main.feels_like}&#8457;</p>
        <p id="feels-like-3rd-day">${day3} ${cityData.list[20].main.feels_like}&#8457;</p>
        <p id="feels-like-4th-day">${day4} ${cityData.list[28].main.feels_like}&#8457;</p>
        <p id="feels-like-5th-day">${day5} ${cityData.list[36].main.feels_like}&#8457;</p>
        <h4>Weather:</h4>
        <p id="weather">Today ${cityData.list[4].weather[0].description}</p>
        <p id="weather-2nd-day">Tomorrow ${cityData.list[12].weather[0].description}</p>
        <p id="weather-3rd-day">${day3} ${cityData.list[20].weather[0].description}</p>
        <p id="weather-4th-day">${day4} ${cityData.list[28].weather[0].description}</p>
        <p id="weather-5th-day">${day5} ${cityData.list[36].weather[0].description}</p>
        `);
    }
};
